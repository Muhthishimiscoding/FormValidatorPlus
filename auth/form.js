...
// data = SubmitForm.overWritedata(data, key, overwrite);
// if (inputObject[key] instanceof FileList || Array.isArray(inputObject[key])) {
//     // In case of fileList or Array
//     for (const file of inputObject[key]) {
//         // data = SubmitForm.overWritedata(data, key, overwriteAll, overWriteFiles, overWriteButNotFiles, overWriteNone);
//         data.append(key, file);
//     }
// } else {
//     //It can be a single file or a normal input
//     data.append(key, inputObject[key]);
// }




// obj.forEach(async (value, key) => {
//     if(value instanceof File){
//         console.log("value is file");
//         form_data_obj[key] = await SubmitForm.readBlobAsBase64(value);
//         console.log(form_data_obj[key]);
//     }else{
...
// });
   ...
   // const array = [], textInputs = [];
                ...
                //     if (form_data_obj.hasOwnProperty(key)) continue;

            //     let all = obj.getAll(key);

            //     if (value instanceof File) {
            //         /**
            //          * It means this key either refers to a single file
            //          * or multiple files [FILELIST] 
            //          */
            //         console.log(key);
            ...
            //                     array.push(await SubmitForm.readBlobAsBase64(file));
            //                 else //It means is not file
            //                     form_data_obj[key] = file;
            //             }
            //             form_data_obj[key] = array;
            //         } else if (all.length === 1) {
            //             /**
            //              * It means that it is a single file
            //              */
            //             form_data_obj[key] = await SubmitForm.readBlobAsBase64(value);
            //         }

            //     } else if (all.length > 1) {
            //         // If multiple same keys exist and then create their array
            //         form_data_obj[key] = all;
            //     } else {
            //         form_data_obj[key] = value;
            //     }
            // }